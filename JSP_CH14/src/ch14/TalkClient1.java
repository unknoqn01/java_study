...
public class TalkClient1 extends MFrame 
implements ActionListener, Runnable {
	...
	public TalkClient1(BufferedReader in, PrintWriter out, String id) {
		super(450, 500);
		this.in = in;
		this.out = out;
		this.id = id; 
	...
	class MDialog extends Dialog implements ActionListener{
		...
		public MDialog(TalkClient1 ct2,String title, String msg) {
